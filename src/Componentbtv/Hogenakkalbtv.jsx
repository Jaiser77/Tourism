...
import Hogenkkal1 from './Imagesbtv/Hogenakkal/hogenakkal1 (1).jpeg'
import Hogenkkal2 from './Imagesbtv/Hogenakkal/hogenakkal1 (2).jpeg'
import Hogenkkal3 from './Imagesbtv/Hogenakkal/hogenakkal1 (3).jpeg'
...
const Hogenkkal = () => {
  ...
  return (
    <div className='container dist2'>
      <h3 className='besttimetovisit-primary-heading' style={{ marginBottom: '0.2rem' }}>10. Hogenkkal</h3>
        ...
        <Col md={6}> 
          <div
            ...
            <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading'><div className='ooty-heading'><b>More About Best Time To Travel To Hogenkkal</b></div></Modal.Title>
              </Modal.Header>
            ...
            <Offcanvas show={isOffcanvasOpen} onHide={handleClose} placement="end">
              <Offcanvas.Header closeButton>
                ...
                <Offcanvas.Title className='offcanvas-title2'>Best Time To Visit In <br /> Hogenkkal</Offcanvas.Title>
                </div>
              </Offcanvas.Header>
              <Offcanvas.Body>
