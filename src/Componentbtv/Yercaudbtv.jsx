...
import Yercaud1 from './Imagesbtv/Yercaud/yercaud1.jpeg'
import Yercaud2 from './Imagesbtv/Yercaud/yercaud2.jpeg'
import Yercaud3 from './Imagesbtv/Yercaud/yercaud3.jpeg'
...
const Yercaud = () => {
  ...
  return (
    <div className='container dist2'>
      <h3 className='besttimetovisit-primary-heading' style={{ marginBottom: '0.2rem' }}>08. Yercaud</h3>
        ...
        <Col md={6}> 
          <div
            ...
            <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading'><div className='ooty-heading'><b>More About Best Time To Travel To Yercaud</b></div></Modal.Title>
              </Modal.Header>
            ...
            <Offcanvas show={isOffcanvasOpen} onHide={handleClose} placement="end">
              <Offcanvas.Header closeButton>
                ...
                <Offcanvas.Title className='offcanvas-title2'>Best Time To Visit In <br />Yercaud</Offcanvas.Title>
                </div>
              </Offcanvas.Header>
              <Offcanvas.Body>
