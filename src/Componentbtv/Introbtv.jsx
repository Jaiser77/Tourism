...
import BestTimeToVisit from './Imagesbtv/Climate.jpeg';
import PillarRocksofKodaikanalSource from './Imagesbtv/image.jpeg';
import ARainyDayinChennaiSource from './Imagesbtv/image1.jpeg';
import PechiparaiReservoirinKanyakumariDistrictSource from './Imagesbtv/image2.jpeg';
...
export default function Introbtv() {
  
  return (
     <div className='container'>
     <h4 className='primary-heading mt-5'>TAMILNADU TOURISM</h4>
     ...
     <Row className="">
         ...
         <Col md={5} className='ms-5'> 
             <br />
             <h5 className='season-heading mb-5'>
