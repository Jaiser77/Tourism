...
import Kanyakumari1 from './Imagesbtv/Kanyakumari/kanyakumari1 (1).jpeg'
import Kanyakumari2 from './Imagesbtv/Kanyakumari/kanyakumari1 (2).jpeg'
import Kanyakumari3 from './Imagesbtv/Kanyakumari/kanyakumari1 (3).jpeg'
         ...
         <div
            ...
            <Modal.Dialog>
              <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading'><b>More About Best Time To Travel To Kanyakumari</b></Modal.Title>
              </Modal.Header>
              ...
              <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleShow} style={{ fontWeight: 'bold' }}>Save changes</Button>
              </Modal.Footer>
            </Modal.Dialog>
          </div>  
          ...
          <div>
            ...
            <Offcanvas show={show} onHide={handleClose} placement="start">
              <Offcanvas.Header closeButton>
                <div className='offcanvas-titleka'>
                <Offcanvas.Title className='offcanvas-titleka'>Best Time To Visit In <br/> Kanyakumari</Offcanvas.Title>
                </div>
              </Offcanvas.Header>
              <Offcanvas.Body>
                  ...
                  <h4 className='season-title'>Kanyakumari in Monsoons (June-September)</h4>
                  <p className='season-text besttimetovisit-bottomtext'>
