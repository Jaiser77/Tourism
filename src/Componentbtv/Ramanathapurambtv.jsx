...
import Rameswaram1 from './Imagesbtv/Rameshwaram/rameshwaram1.jpeg'
import Rameswaram2 from './Imagesbtv/Rameshwaram/rameshwaram2.jpeg'
import Rameswaram3 from './Imagesbtv/Rameshwaram/rameshwaram3.jpeg'
...
const Rameswaram = () => {
  ...
  return (
    <div className='container dist2'>
      <h3 className='besttimetovisit-primary-heading' style={{ marginBottom: '0.2rem' }}>02. Rameswaram</h3>
          ...
          <div
            ...
            <Modal.Dialog show={isModalOpen} onHide={handleClose} backdrop={false}>
              <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading'><b>More About Best Time To Travel To Rameswaram</b></Modal.Title>
              </Modal.Header>
            ...
            <Offcanvas show={isOffcanvasOpen} onHide={handleClose} placement="end">
              <Offcanvas.Header closeButton>
                <Offcanvas.Title className='offcanvas-titlera'>Best Time To Visit In Rameshwaram</Offcanvas.Title>
              </Offcanvas.Header>
              <Offcanvas.Body>
