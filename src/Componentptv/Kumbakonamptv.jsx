...
export default function Kumbakonamptv() {
  return (
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Kumbakonam</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kumbakonam/kumbakonam1 (1).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Sarangapani Temple, Overview</b></h6>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Nageswaran Temple, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            houses three gateway towers known as gopurams.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kumbakonam/kumbakonam1 (2).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kumbakonam/kumbakonam1 (3).jpeg")} style={{ height: '223px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Adi Kumbeshwara Temple, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Airavatesvara Temple, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            Yamuna, Subrahmanya, Ganesha, Kama, Rati and others.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kumbakonam/kumbakonam1 (4).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>
