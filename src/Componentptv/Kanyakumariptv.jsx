...
export default function Kanyakumariptv() {
  return (
   
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Kanyakumari</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kanyakumari/kanyakumari1 (1).jpeg")} style={{ height: '200px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Kanyakumari Beach, Overview</b></h6>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Vivekananda Memorial, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            life and work in depth.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kanyakumari/kanyakumari1.(2).jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kanyakumari/kanyakumari1 (3).jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Thiruvalluvar Statue, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Thirparappu Falls, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            small temple dedicated to Lord Shiva and is highly revered by the locals.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Kanyakumari/kanyakumari1 (4).jpeg")} style={{ height: '210px',width:'170px' }}></img>
              </div>
