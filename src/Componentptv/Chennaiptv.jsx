...
export default function Chennaiptv() {
  return (
<div>
    <div className="container mt-5 mb-4">
         <h3 className='text-center'>Chennai</h3>
         <h4 className='text-center'>Tourist Places Visit</h4>

         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Chennai/chennai1.jpeg")} style={{ height: '250px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Marina beach,Overview</b></h6>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>MGR Flim City, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Chennai/chennai2.jpeg")} style={{ height: '235px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Chennai/chennai3...jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Marundeeswarar Temple, Overview</b></h6>
                   <p className='p1'style={{ textAlign: 'justify' }}>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Breezy Beach, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            less polluted, its a perfect getaway for anyone looking for a peaceful evening.
                   ...
                   <p className='p1' style={{ textAlign: 'justify' }}>
                   his beach is not as popular and known as the Elliots beach, and is hence more quiet and peaceful. Evenings
            ...
            is the place to be.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Chennai/chennai4.jpeg")} style={{ height: '173px',width:'170px' }}></img>
                </div>
