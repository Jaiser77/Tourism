...
export default function Yercaudptv() {
  return (
  ...
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Yercaud</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Yercaud/yercaud...(1).jpeg")} style={{ height: '243px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Pagoda Point, Overview</b></h6>
...
with sights of the craggy cliffs
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Botanical Garden, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            species of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Yercaud/yercaud1 (2).jpeg")} style={{ height: '192px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Yercaud/yercaud1.(3).jpeg")} style={{ height: '177px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Emerland Lake, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
...
issuing the boats and austere safety measures are followed by the authorities
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Lady's Seat, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
...
reflected in its waters
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Yercaud/yercaud1 (4).jpeg")} style={{ height: '237px',width:'170px' }}></img>
              </div>
