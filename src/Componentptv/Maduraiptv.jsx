...
export default function Maduraiptv() {
  return (
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Madurai</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Madurai/madurai1..jpeg")} style={{ height: '243px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Vaigai Dam, Overview</b></h6>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Meghamalai, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            metres above sea level, this small mountain village is surrounded by tea and cardamom plantations.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Madurai/madurai2.jpeg")} style={{ height: '238px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Madurai/madurai3..jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Samanar Hills, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Thirumalai Nayakar, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            kept for display.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Madurai/madurai4..jpeg")} style={{ height: '223px',width:'170px' }}></img>
              </div>
