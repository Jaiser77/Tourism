...
export default function Ootyptv() {
  return (
    
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Ooty</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Ooty/ooty1 (1).jpeg")} style={{ height: '200px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Nilgiri Mountain Railway, Overview</b></h6>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Ooty Botanical Gardens, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            known as the Toda mund, which gives the visitors an insight into the lives and culture of Todas (a tribe of the Nilgiris).
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Ooty/ooty1 (2).jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Ooty/ooty1 (3).jpeg")} style={{ height: '245px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Emerald Lake, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Dolphin's Nose, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            is located at a short distance from the Dolphin's Nose. 
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Ooty/ooty1 (4).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>
