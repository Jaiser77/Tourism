...
export default function Kodaikanalptv() {
  return (
    
 <div>
      <div>
    <div className="container mt-5 mb-4">
         <h3 className='text-center'>Kodaikanal</h3>
         <h4 className='text-center'>Tourist Places Visit</h4>

         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Kodaikanal/kodaikanal1....jpeg")} style={{ height: '195px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Green Valley View, Overview</b></h6>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Kodai Lake, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Kodaikanal/kodaikanal2.jpeg")} style={{ height: '195px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Kodaikanal/kodaikanal3..jpeg")} style={{ height: '220px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Bear Shola Falls, Overview</b></h6>
                   <p className='p1'style={{ textAlign: 'justify' }}>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Pillar Rocks, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            ways become clear nothing beautiful than this could be ever seen.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Kodaikanal/kodaikanal4.jpeg")} style={{ height: '230px',width:'170px' }}></img>
                </div>
