...
export default function Hogenakalptv() {
  return (
    
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Hogenakal</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Hogenakkal/hogenakkal1.jpeg")} style={{ height: '245px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Theerthamalai Temple,Overview</b></h6>
...
temple was built during 7th Century when the Cholas and the Pandya's were ruling this dynasty.
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Hogenakkal Falls, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
...
medicinal properties, owing to the numerous herbs that grow in its path. Known for its pristine appeal.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Hogenakkal/hogenakkal2..jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Hogenakkal/hogenakkal3.jpeg")} style={{ height: '222px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Pennagaram village, Overview</b></h6>
                 <p className='p1'style={{ textAlign: 'justify' }}>
...
including 7,266 urban houses and 50,132 rural houses.
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Mettur Dam, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
...
land around it. Another major attraction of the area is a water reservoir flanked by hilly ranges all around.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Hogenakkal/hokenakkal4..jpeg")} style={{ height: '238px',width:'170px' }}></img>
              </div>
