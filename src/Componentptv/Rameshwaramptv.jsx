...
export default function Rameshwaramptv() {
  return (
    <div>
      <div>
    <div className="container mt-5 mb-4">
         <h3 className='text-center'>Rameshwaram</h3>
         <h4 className='text-center'>Tourist Places Visit</h4>

         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Rameshwaram/rameshwarem1.jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Dhanushkodi Temple</b></h6>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Lakshmana Temple, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Rameshwaram/rameshwarem2.jpeg")} style={{ height: '180px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Rameshwaram/rameshwarem4.jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>

                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Villoondi Tirtham, Overview</b></h6>
                   <p className='p1'style={{ textAlign: 'justify' }}>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 <h6 className=''><b>Rameshwaram Temple, Overview</b></h6>
                   <p className='p1 ' style={{ textAlign: 'justify' }}>
            ...
            there are absorbing festivals worth witnessing.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./ImagesPtv/Rameshwaram/Rameshwaram3..jpeg")} style={{ height: '230px',width:'170px' }}></img>
                </div>
