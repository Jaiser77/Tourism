...
export default function Theniptv() {
  return (
    
    <div>
    <div>
  <div className="container mt-5 mb-4">
       <h3 className='text-center'>Theni</h3>
       <h4 className='text-center'>Tourist Places Visit</h4>

       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Theni/theni1.(1).jpeg")} style={{ height: '220px',width:'170px' }}></img>
              </div>

              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Chinna Suruli Falls, Overview</b></h6>
...
younger, so in a sense, it is called the younger Suruli
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Kumbakkarai Falls, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
...
when the water level is high and the neighboring areas glows with greenery.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Theni/theni1 (2).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Theni/theni1.(3).jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>
...
of tea and coffee plantations
       ...
       <div className="container">
          <div className="row">
              ...
              <div className="col-sm-10 mt-5 mb-3 pt-2" >
               <h6 className=''><b>Suruli Falls, Overview</b></h6>
                 <p className='p1 ' style={{ textAlign: 'justify' }}>
...
reachable by road from Kambam and Gudalur towns
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./ImagesPtv/Theni/theni1.(4).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
