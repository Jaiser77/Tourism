...
function Ooty() {
  return (
   ...
   <div className="row">
        ...
        <div className="col-sm">
           <div className='mt-2'>
               <h6><b>“Queen of the Nilgiris”</b></h6>
               <p className='mt-3 p'>
...
architecture, Ooty is the perfect respite everyone.
      ...
      <div className="row mb-3 ">
        ...
        <Card style={{ width: '250px',height:'400px' }} className="flex-grow-1">
                   <Card.Img variant="top" src={Ot1} style={{height: '167px'}} />
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px', height:'400px' }}>
                   <Card.Img variant="top" src={Ot3} style={{height: '167px'}}/>
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px',height:'400px' }}>
                   <Card.Img variant="top" src={Ot4} style={{height: '167px'}} />
                     <Card.Body>
