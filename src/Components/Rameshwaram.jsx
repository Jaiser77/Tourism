   ...
   <div className="row">
      ...
      <div className="row mb-3 ">
        ...
        <Card style={{ width: '250px' ,height: '400px'}} className="flex-grow-1">
                   <Card.Img variant="top" src={Rm1} style={{height: '168px'}}/>
                     <Card.Body>
        ...
        <Card style={{ width: '250px',height: '400px' }}>
                   <Card.Img variant="top" src={Rm2} style={{height: '180px'}} />
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px',height: '400px' }}>
                   <Card.Img variant="top" src={Rm3} style={{height: '180px'}} />
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px',height: '400px' }}>
                   <Card.Img variant="top" src={Rm4} style={{height: '180px'}}/>
                     <Card.Body>
