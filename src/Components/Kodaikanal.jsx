...
surrounding the town.
      ...
      <div className="row mb-3 ">
        ...
        <Card style={{ width: '250px',height: '390px' }} className="flex-grow-1">
                   <Card.Img variant="top" src={Ko1} style={{height: '180px'}}/>
                     <Card.Body>
        ...
        <Card style={{ width: '250px',height: '390px' }}>
                   <Card.Img variant="top" src={Ko2} style={{height: '180px'}}/>
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px',height: '390px' }}>
                   <Card.Img variant="top" src={Ko3} style={{height: '180px'}} />
                     <Card.Body>
        ...
        <div className="col-sm box ">
               <Card style={{ width: '250px',height: '390px' }}>
                   <Card.Img variant="top" src={Ko4} style={{height: '180px'}} />
                     <Card.Body>
